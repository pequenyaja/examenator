  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="<?php echo $data['url_base']?>/index.php/themes">Elegir un tema</a></li>
    ...
    <div class="container">
      ...
      <main class="text-center">
        <form method="POST" action="<?php echo $data['actionForm']; ?>">
          <label><?php echo $data['question']['pregunta'] ?></label><br/>
          <?php 
            foreach ($data['answers'] as $answers){
            echo '<input type="radio" name="answerIdSelected" value="'.$answers['id'].'" required/>'.$answers['respuesta'].'<br/>';
            } 
            echo '<br/> <input type="submit" class="btn btn-default" name="answer" value="Enviar respuesta"/> <br/><br/>';
            if (isset($data['nextQuestion'])){
              echo '<a href="'.$data['nextQuestion'].'">Next Question</a>';
            }
            else{
            echo '<a href="../../../../index.php/themes">Volver a elegir un tema</a>';
            }
          ?>
        </form>
      </main>
