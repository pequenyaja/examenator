  ...
  <body>
    ...
    <div class="container">
      ...
      <main class="text-center">
        <?php 
          echo "<h4>".$data['theme']['titulo']."</h4>";
          echo "<a href='../../index.php/themes/".$data["theme"]["titulo_url"]."/question/1'>Let's play a game</a><br/>";
        ?>
        <img src="<?php echo $data['url_base']?>/img/saw.jpeg" alt="saw" class="img-rounded" style="width: 650px;"></img> 
      </main>
